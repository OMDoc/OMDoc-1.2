<!--
   ...
   General OMDoc Class Definitions (for mixed content)
     $Id: omdoc-classes.mod 8014 2008-09-07 19:52:19Z kohlhase $
     $HeadURL: https://svn.omdoc.org/repos/omdoc/branches/omdoc-1.2/dtd/omdoc-classes.mod $
     PUBLIC: -//OMDoc//CLASSES OMDoc V1.2//EN
...
<!-- recursion. -->
<![%omdoc.cc.module;[
  <!ENTITY % omdoc-CC-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc CC V1.2//EN" "omdoc-CC-classes.mod">
  %omdoc-CC-classes.mod;]]>
<!ENTITY % omdoccc.class "">

<!ENTITY % omdoc-DC-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc DC V1.2//EN" "omdoc-DC-classes.mod">
%omdoc-DC-classes.mod;

<![%omdoc.rt.module;[
   <!ENTITY % omdoc-RT-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc RT V1.2//EN"
                                 "omdoc-RT-classes.mod">
   %omdoc-RT-classes.mod;]]>
<!ENTITY % omdocrt.mtext.mix "">

<![%omdoc.ext.module;[
   <!ENTITY % omdoc-EXT-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc EXT V1.2//EN"
                                  "omdoc-EXT-classes.mod">
   %omdoc-EXT-classes.mod;]]>
<!ENTITY % omdocext.mtext.mix "">
<!ENTITY % omdocext.class "">

<!ENTITY % omdoc-DOC-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc DOC V1.2//EN"
                                  "omdoc-DOC-classes.mod">
%omdoc-DOC-classes.mod;

<!ENTITY % omdoc-MOBJ-classes.mod PUBLIC "-//OMDoc//DTD OMDoc MOBJ V1.2//EN" "omdoc-MOBJ-classes.mod">
%omdoc-MOBJ-classes.mod;

<!ENTITY % omdocmtxt-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc MTXT V1.2//EN"
                                  "omdoc-MTXT-classes.mod">
%omdocmtxt-classes.mod;

<![%omdoc.st.module;[
   <!ENTITY % omdoc-ST-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc ST V1.2//EN"
...
<![%omdoc.adt.module;[
   <!ENTITY % omdoc-ADT-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc ADT V1.2//EN"
                                  "omdoc-ADT-classes.mod">
   %omdoc-ADT-classes.mod;]]>
<!ENTITY % omdocadt.constitutive.class "">

<![%omdoc.pres.module;[
   <!ENTITY % omdoc-PRES-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc PRES V1.2//EN"
...
<![%omdoc.pf.module;[
   <!ENTITY % omdoc-PF-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc PF V1.2//EN"
...
<![%omdoc.quiz.module;[
   <!ENTITY % omdoc-QUIZ-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc QUIZ V1.2//EN"
                                  "omdoc-QUIZ-classes.mod">
    %omdoc-QUIZ-classes.mod;]]>
<!ENTITY % omdocquiz.class "">

<![%omdoc.cth.module;[
   <!ENTITY % omdoc-CTH-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc CTH V1.2//EN"
...
<![%omdoc.dg.module;[
   <!ENTITY % omdoc-DG-classes.mod PUBLIC "-//OMDoc//CLASSES OMDoc DG V1.2//EN"
