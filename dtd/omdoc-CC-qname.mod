<!--
   An XML DTD for Open Mathematical documents (OMDoc 1.2) Module CC Entities
     $Id: omdoc-CC-qname.mod 8014 2008-09-07 19:52:19Z kohlhase $
     $HeadURL: https://svn.omdoc.org/repos/omdoc/branches/omdoc-1.2/dtd/omdoc-CC-qname.mod $
     PUBLIC -//OMDoc//ENTITIES OMDoc CC V1.2//EN
