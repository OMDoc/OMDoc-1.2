<!--
   An XML DTD for Open Mathematical documents (OMDoc 1.2): Module MTXT Entities
     $Id: omdoc-MTXT-qname.mod 8014 2008-09-07 19:52:19Z kohlhase $
     $HeadURL: https://svn.omdoc.org/repos/omdoc/branches/omdoc-1.2/dtd/omdoc-MTXT-qname.mod $
