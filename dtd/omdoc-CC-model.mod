<!--
   An XML DTD for Open Mathematical documents (OMDoc 1.2) Module CC
     $Id: omdoc-CC-model.mod 8014 2008-09-07 19:52:19Z kohlhase $
     $HeadURL: https://svn.omdoc.org/repos/omdoc/branches/omdoc-1.2/dtd/omdoc-CC-model.mod $
     PUBLIC -//OMDoc//ELEMENTS OMDoc CC V1.2//EN
