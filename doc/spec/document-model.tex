...
\svnInfo $Id: document-model.tex 8481 2009-08-11 05:41:59Z kohlhase $
...
\begin{tsubsection}[id=spec-intro:reusing]{Reusing {\omdoc} modules in other formats}
  ...
  the {\omdoc} statement level.  Including modules {\MOBJmodule{spec}}, {\DCmodule{spec}},
  and (parts of) {\MTXTmodule{spec}}, but not {\RTmodule{spec}} and {\DOCmodule{spec}}
  ...
  for interoperability in {\mychapref{rpc}}.
\end{tsubsection}
\end{tsection}
