...
\svnInfo $Id: courseware.tex 8483 2009-08-11 08:16:04Z kohlhase $
...
save space. The {\erratumReplace[date=2006-09-01,reported-by=Michael Kohlhase]{forgot to
    thread through attribute renaming}{proofs}{just-by}{{\attribute{just-by}{assertion}}}}
can be used to point to set of proofs for this assertion, in this case only the one given
in {\mylstref{var-cvi-ex}}. We use the {\omdoc} {\element{proof}} element to mark up this
proof.  It contains a series of {\element{derive}} proof steps. In our case, the argument
...
{\element{omgroup}} element (the value {\attval{itemize}{type}{omgroup}}
