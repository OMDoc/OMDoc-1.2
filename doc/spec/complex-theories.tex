...
\svnInfo $Id: complex-theories.tex 6813 2007-09-13 15:27:43Z clange $
...
\begin{tchapter}[id=complex-theories,short=Complex Theories]{Complex Theories (Modules
  ...
  {\mysecref{theories}} to that of ``{\twintoo{theory}{inclusion}s}'', also
  called ``{\twintoo{theory}{morphism}s}'' or ``{\twintoo{theory}{interpretation}s}''
...
details. {\erratumAdd[reported-by=Florian Rabe,date=2006-11-21]{noted special case}{The
  definition of hiding used there is more general. The variant used here arises as the
  special case where the hiding morphism, which goes against the import direction, is an
  inclusion; then the symbols that are not in the image are the hidden ones.}}  If we
...
\erratumReplace[reported-by=Florian Rabe,date=2006-11-21]
  {Clarified wording}
  {{\snippet{globals="\ldots\#\llquote{ref1}\#\llquote{ref2}\ldots"}} there must be theory
    inclusions $\sigma_i$ with {\snippet{xml:id="}\llquote{refi}\snippet{"}}, such that
    the target theory of $\sigma_{i-1}$ is the source theory of $\sigma_i$}
  {{\snippet{base="\#\llquote{ref1}\ldots \#\llquote{refn}"}} there must be theory
...
\begin{tsection}[id=theory-inclusions]{Postulated Theory Inclusions}
  ...
  {\attributeshort{conservativity}}\erratumAdd[reported-by=Kristina
  Sojakova,date=2007-09-10]{added missing word}{ attribute}. The values \erratumReplace[reported-by=Kristina
  Sojakova,date=2007-09-10]{Fixed value of the {\tt conservativity}
  attribute}{\attvalshort{conservative}{conservativity}}{\attvalshort{conservative}{conservativity}}
  and \erratumReplace[reported-by=Kristina Sojakova,date=2007-09-10]{Fixed value of the
  {\tt conservativity}
  attribute}{\attvalshort{conservative}{definitional}}{\attvalshort{definitional}{conservativity}}
  are used for the two cases discussed above. There is a third value:
  \erratumReplace[reported-by=Kristina Sojakova,date=2007-09-10]{Fixed value of the {\tt
  conservativity}
  attribute}{\attvalshort{conservative}{conservativity}}{\attvalshort{monomorphism}{conservativity}},
