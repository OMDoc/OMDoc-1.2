...
\svnInfo $Id: mobj-rnc.tex 6154 2006-10-03 11:31:31Z  $
...
\begin{tsection}[id=rnc:mathml]{The RelaxNG Schema for MathML}
  ...
  \lstinputlisting[nolol,language=RNC,index={m:math}]{../../rnc/mathml2/mathml2.rnc}

\begin{tsubsection}[id=rnc:pmathml]{Presentation {\mathml}}
  \lstinputlisting[nolol,language=RNC,index={m:math}]{../../rnc/mathml2/mathml2-presentation.rnc}
\end{tsubsection}

\begin{tsubsection}[id=rnc:cmathml]{Content {\mathml}}
  \lstinputlisting[nolol,language=RNC,index={m:math}]{../../rnc/mathml2/mathml2-content.rnc}
\end{tsubsection}
\end{tsection}
\end{tchapter}
